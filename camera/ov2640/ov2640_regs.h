...
/* Register bit masks and offsets for status reading */
/* REG45 - AEC[15:10] */
#define REG45_AEC_MASK      0x3F
#define REG45_AEC_OFFSET    0

/* REG04 - AEC[1:0] */
#define REG04_AEC_MASK      0x03
#define REG04_AEC_OFFSET    0
#define REG04_HMIRROR_MASK  0x80
#define REG04_HMIRROR_OFFSET 7
#define REG04_VFLIP_MASK    0x40
#define REG04_VFLIP_OFFSET  6

/* COM9 - Gain ceiling */
#define COM9_GAINCEILING_MASK    0xE0
#define COM9_GAINCEILING_OFFSET  5

/* COM8 - Auto/Manual control */
#define COM8_AEC_MASK       0x01
#define COM8_AEC_OFFSET     0
#define COM8_AGC_MASK       0x04
#define COM8_AGC_OFFSET     2

/* CTRL1 - AWB and other controls */
#define CTRL1_AWB_MASK      0x08
#define CTRL1_AWB_OFFSET    3
#define CTRL1_AWB_GAIN_MASK 0x04
#define CTRL1_AWB_GAIN_OFFSET 2
#define CTRL1_RAW_GMA_MASK  0x20
#define CTRL1_RAW_GMA_OFFSET 5
#define CTRL1_LENC_MASK     0x02
#define CTRL1_LENC_OFFSET   1

/* CTRL0 - AEC2 */
#define CTRL0_AEC2_MASK     0x40
#define CTRL0_AEC2_OFFSET   6

/* CTRL3 - BPC and WPC */
#define CTRL3_BPC_MASK      0x80
#define CTRL3_BPC_OFFSET    7
#define CTRL3_WPC_MASK      0x40
#define CTRL3_WPC_OFFSET    6

/* CTRL2 - DCW */
#define CTRL2_DCW_MASK      0x20
#define CTRL2_DCW_OFFSET    5

/* COM7 - Color bar test */
#define COM7_COLORBAR_MASK  0x02
#define COM7_COLORBAR_OFFSET 1
